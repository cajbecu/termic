...
**Git** is one surface with two halves: the working tree at the top (Fork-style staging) and, at its foot, a collapsible **Graph** section holding what has already been committed (issue #199).
